...
from ...ports import AssetPorts, MediaPorts, MomentPorts, StatePorts, SynthesisPorts
from ...types import AssetRef, FrameSample, FrameSource, MediaHandle, MemberId, TimeRange, VideoRef
...
class InMemoryMediaService(MediaService):
    ...
    def __init__(self, ports: MediaPorts) -> None:
...
class InMemoryStateService(StateService):
    ...
    def __init__(self, ports: StatePorts) -> None:
        self._meta_store = ports.meta_store
        self._observer = ports.observer
...
class InMemoryMomentService(MomentService):
    ...
    def __init__(self, ports: MomentPorts) -> None:
        self._observer = ports.observer
...
class InMemoryAssetService(AssetService):
    ...
    def __init__(self, ports: AssetPorts) -> None:
        self._meta_store = ports.meta_store
        self._asset_index = ports.asset_index
...
class InMemorySynthesisService(SynthesisService):
    ...
    def __init__(self, ports: SynthesisPorts) -> None:
        self._blob_store = ports.blob_store
