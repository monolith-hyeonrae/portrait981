...
- moment는 동일 media_handle/timebase(ms)를 기준으로 state_timeline_ref와 정합한다.
...
- member_id가 없는 Discover에서는 고객 히스토리 기반 중복 제거를 생략할 수 있다.
- moment는 필요 시 별도 frame_source를 요청하되 동일 media_handle을 사용한다.
