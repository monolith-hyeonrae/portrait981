...
from facemoment.algorithm.analyzers.face_classifier.types import ClassifiedFace
from facemoment.algorithm.analyzers.face_classifier.output import FaceClassifierOutput
