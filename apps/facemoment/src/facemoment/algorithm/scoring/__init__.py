...
Example:
    >>> from facemoment.algorithm.scoring import FrameScorer, ScoringConfig
    >>>
...
from facemoment.algorithm.scoring.frame_scorer import (
    FrameScorer,
    ScoringConfig,
    ScoreResult,
    ScoreBreakdown,
)
from facemoment.algorithm.scoring.frame_selector import (
    FrameSelector,
    SelectionConfig,
    ScoredFrame,
)
