...
from momentscan.algorithm.analyzers.portrait_score.types import PortraitScoreOutput
...
class PortraitScoreAnalyzer(Module):
    ...
    def initialize(self) -> None:
        ...
        if self._enable_aesthetic:
            try:
                from momentscan.algorithm.analyzers.portrait_score.backends.clip_portrait import CLIPPortraitScorer
