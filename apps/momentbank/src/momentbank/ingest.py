...
from momentbank.paths import get_bank_dir, get_bank_path
from momentbank.persistence import load_bank, save_bank
...
def save_selected_frames(
    ...
    ``~/.portrait981/momentbank/{shard}/{member_id}/frames/``.
...
def ingest_collection(
    ...
    at ``~/.portrait981/momentbank/{shard}/{member_id}/memory_bank.json``
