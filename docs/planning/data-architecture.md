...
momentbank      = 서비스 "기억" (member 단위, 검증된 것만)
```
...
data/momentbank/          ← 고객 기억 (member_id 필수)
└── members/
...
```
filename | au1_inner_brow | ... | backlight_score (49D)
```
