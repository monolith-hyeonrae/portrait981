...
class FlowGraph:
    ...
    def _check_module_dependencies(self) -> None:
        ...
        For each node containing modules (ModuleSpec),
    ...
    def to_dot(self, title: str = "FlowGraph") -> str:
        ...
        """
        from visualpath.flow.viz import to_dot
        return to_dot(self, title)
    ...
    def print_ascii(self) -> str:
        ...
        """
        from visualpath.flow.viz import print_ascii
        return print_ascii(self)
